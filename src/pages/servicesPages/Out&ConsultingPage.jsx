...
import { 
    ...
    Check, Phone, Mail, HeadphonesIcon 
} from "lucide-react"; 
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            >
                ...
                <h1 className="text-4xl md:text-5xl font-extrabold leading-tight text-[#1F2937]">
                    Outsourcing & Consulting: From <span className="text-[#3B82F6]">Strategy to Execution</span>
                </h1>
                <p className="text-lg text-gray-600">
                    We provide comprehensive IT outsourcing and consulting services to help businesses optimize their technology operations, reduce costs, and accelerate growth through strategic partnerships.
                </p>
                <motion.a 
                    href="#core-services"
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            >
                <h3 className="text-4xl font-extrabold text-[#1F2937]">
                    Strategic Partnership & <span className="text-[#3B82F6]">Expert Guidance</span>
                </h3>
                <p className="text-lg text-gray-600">
                    Our outsourcing and consulting services provide you with access to expert teams and strategic guidance. We help businesses scale efficiently while maintaining quality and reducing operational costs.
                </p>
                <ul className="list-disc list-inside text-lg text-gray-600 space-y-2 pl-4">
                    <li>**Cost Optimization:** Reduce operational costs by up to 40% through strategic outsourcing.</li>
                    <li>**Expert Teams:** Access to specialized talent and cutting-edge technologies.</li>
                    <li>**Scalable Solutions:** Flexible team scaling based on project requirements.</li>
                </ul>
            </motion.div>
...
const CardGridSection = () => {
    const coreServices = [
        { icon: Briefcase, title: "IT Strategy Consulting", description: "Strategic planning and technology roadmap development for business growth." },
        { icon: Users, title: "Dedicated Development Teams", description: "Skilled developers working exclusively on your projects and goals." },
        { icon: Target, title: "Project Management", description: "End-to-end project management with agile methodologies and delivery." },
        { icon: Database, title: "Infrastructure Management", description: "Complete IT infrastructure setup, monitoring, and maintenance services." },
        { icon: Cloud, title: "Cloud Migration Services", description: "Seamless migration to cloud platforms with minimal downtime." },
        { icon: Shield, title: "Quality Assurance", description: "Comprehensive testing and quality assurance for all deliverables." },
        { icon: Globe, title: "24/7 Support Services", description: "Round-the-clock technical support and maintenance services." },
        { icon: TrendingUp, title: "Performance Optimization", description: "Continuous monitoring and optimization of systems and processes." },
    ];
        ...
        >
            <div className="max-w-7xl mx-auto">
                <motion.h2 className="text-4xl font-extrabold text-[#1F2937] mb-12 text-center" variants={itemVariants}>
                    Our <span className="text-[#3B82F6]">Outsourcing & Consulting Services</span>
                </motion.h2>
    ...
    >
        <div className="max-w-7xl mx-auto">
            <h2 className="text-4xl md:text-5xl font-extrabold text-[#1F2937] mb-16 text-center">
                Outsourcing & Consulting <span className="text-[#3B82F6]">Service Models</span>
            </h2>
...
const ContactSection = () => (
    <section className="py-20 px-4 sm:px-10 bg-gray-50 border-t border-gray-200">
        <div className="max-w-3xl mx-auto p-10 bg-white rounded-xl shadow-2xl text-center">
            <h2 className="text-3xl font-bold mb-4 text-[#1F2937]">Ready to Partner with Us?</h2>
